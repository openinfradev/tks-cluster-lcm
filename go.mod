...
require (
	...
	github.com/openinfradev/tks-common v0.0.0-20221121042940-4356d48a950b // indirect
	github.com/openinfradev/tks-proto v0.0.6-0.20221117013032-f3e8aa863671 // indirect
