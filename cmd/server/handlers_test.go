...
func TestCreateCluster(t *testing.T){
	testCases := []struct {
		...
		buildStubs		func(	mockArgoClient *mockargo.MockClient,
								mockCspInfoClient *mock.MockCspInfoServiceClient, 
								mockClusterInfoClient *mock.MockClusterInfoServiceClient, 
								mockContractClient *mock.MockContractServiceClient )
		...
		},
		{
			...
			buildStubs:	func(	mockArgoClient *mockargo.MockClient,
				...
				mockClusterInfoClient.EXPECT().AddClusterInfo( gomock.Any(), gomock.Any(), ).Times(1).
					Return(
						&pb.IDResponse{
					}, errors.New("FAILED TO ADD CLUSTER"))
			},
			checkResponse: func(req *pb.CreateClusterRequest, res *pb.IDResponse, err error){
				require.NoError(t, err)
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			mockCspInfoClient := mock.NewMockCspInfoServiceClient(ctrl)
			cspInfoClient = mockCspInfoClient
			mockClusterInfoClient := mock.NewMockClusterInfoServiceClient(ctrl)
			clusterInfoClient = mockClusterInfoClient
			mockContarctClient := mock.NewMockContractServiceClient(ctrl)
...
func TestInstallAppGroups(t *testing.T){
	testCases := []struct {
		...
		buildStubs		func(	mockArgoClient *mockargo.MockClient,
								mockAppInfoClient *mock.MockAppInfoServiceClient, 
								mockClusterInfoClient *mock.MockClusterInfoServiceClient )
		...
		},
		{
			...
			buildStubs:	func(	mockArgoClient *mockargo.MockClient,
				...
				mockClusterInfoClient.EXPECT().GetCluster( gomock.Any(), gomock.Any(), ).Times(1).
					...
					}, errors.New("NOT_EXIST_CLUSTER_ID" ))
			},
			checkResponse: func(req *pb.InstallAppGroupsRequest, res *pb.IDsResponse, err error){
				require.NoError(t, err)
				require.Equal(t, res.Code, pb.Code_OK_UNSPECIFIED)
	...
	for i := range testCases {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			mockAppInfoClient := mock.NewMockAppInfoServiceClient(ctrl)
